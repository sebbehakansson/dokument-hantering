...
export default function AddNew() {
  const [newPost, setNewDoc] = useState({
    title: "",
    content: "",
    user: ""
  });
          ...
          <div className="divide-y divide-gray-200">
            <form onSubmit={submit}  className="py-8 text-base leading-6 space-y-4 text-gray-700 sm:text-lg sm:leading-7">
              <div className="relative">
                <input placeholder='Titel' value={newPost.title}  onChange={(e) => setNewDoc((prev) => {return {...prev, title: e.target.value}})} name='title' type="text" className="peer placeholder-transparent h-10 w-full border-b-2 border-gray-300 text-gray-900 focus:outline-none focus:borer-rose-600" />
              ...
              <div className="relative">
                <textarea name="description" value={newPost.content}  onChange={(e) => setNewDoc((prev) => {return {...prev, content: e.target.value}})}  className="peer placeholder-transparent h-10 w-full border-b-2 border-gray-300 text-gray-900 focus:outline-none focus:borer-rose-600" placeholder="Inehåll" />
              ...
              <div className="relative">
                <input placeholder='Användare' name='user' value={newPost.user} onChange={(e) => setNewDoc((prev) => {return {...prev, user: e.target.value}})} type="text" className="peer placeholder-transparent h-10 w-full border-b-2 border-gray-300 text-gray-900 focus:outline-none focus:borer-rose-600" />
